...
<p align="center">
  <a href="https://git.io/typing-svg">
    <img src="https://readme-typing-svg.demolab.com?font=Inter&weight=600&size=22&duration=3200&pause=900&color=7C3AED&center=true&vCenter=true&width=980&lines=CPaaS+%E2%80%A2+SMS+%E2%80%A2+RCS+%E2%80%A2+WhatsApp+%E2%80%A2+SMPP;Integrations%2C+APIs%2C+BI+and+Automation;Onboarding%2C+Operations+and+Messaging+at+Scale;Building+Solutions+That+Drive+Control+and+Results" alt="Typing SVG" />
  </a>
</p>
...
I work as a **Solutions Engineer** focused on **CPaaS, messaging solutions, integrations, BI, and operational automation**.

Currently, I work on technical and operational initiatives that support product evolution, customer operations, and business visibility, including:
...
- Creation of **dashboards** for agent monitoring and operational control
- Technical **onboarding** and customer support
- Development, maintenance, and data feeding of the **operational BI platform**
...
My focus is on using technology to generate **control, scalability, efficiency, and measurable results**.
...
<p align="center">
  ...
  <img src="https://img.shields.io/badge/SMS-5B21B6?style=for-the-badge" />
...
- Academic background focused on software development, databases, and application architecture
- Experience with web development, mobile development, and programming logic
- Technical foundation in system development, modeling, and integration between layers

**Technologies and Languages:** `Java` `C++` `Node.js` `JavaScript` `TypeScript` `HTML` `CSS` `React` `React Native` `SQL` `Oracle` `MySQL` `Git` `GitHub`
...
- Technical education focused on systems development and databases
- Learning focused on web development and application structure
- Solid foundation in logic, programming, and solution modeling

**Technologies and Languages:** `C#` `JavaScript` `HTML` `CSS` `PHP` `MySQL` `SQL Server` `Git` `GitHub` `Programming Logic`
...
- Technical education focused on programming, logic, interactivity, and digital project development
- Experience with game engines, interface structure, and applied logic
- Creative and technical foundation for building digital products

**Technologies and Languages:** `C#` `Unity` `Laravel` `JavaScript` `HTML` `CSS` `Game Design` `Programming Logic` `Git`
...
- Development of an **RCS agent provisioning form/platform**
- Creation of **dashboards** for agent control and monitoring
- Technical **onboarding** and customer support
- Creation, maintenance, and data feeding of the **operational BI platform**
- Development of **Python automations** for operational efficiency
- Management of **SMS routes**, including pricing, deliverability, costs, connectivity, and suppliers
- Operational monitoring of **SMS, RCS, WhatsApp, and SaaS products**

**Technologies:** `Python` `JavaScript` `SQL` `PostgreSQL` `MySQL` `Linux` `SMPP` `Kannel` `Google RCS` `Power BI` `APIs` `Automation` `Dashboards`
...
- Mobile development with **React Native** for applications used by major clubs and brands, including **Palmeiras, Grêmio, Cruzeiro, Orlando City, and Chicago Fire**
- Front-end interface development focused on usability, navigation, and performance
- Integration of features with **Firebase** and **Salesforce**
- State management using **Redux**
- Connection between the app, services, and databases to support product features
- Participation in the evolution of flows, screens, and reusable components
- Support in application maintenance and continuous improvement
...
- Strong experience in **enterprise messaging and CPaaS operations**
- Hands-on experience with **SMPP, Google RCS, onboarding, and technical support**
- Development of internal solutions for **operational control and data visibility**
- Profile focused on **scalability, performance, automation, and efficiency**
- Ability to connect **technology, operations, and business**
